...
if (-not (Test-Path $imgPath)) {
    try {
        $wr = [System.Net.WebRequest]::Create('https://raw.githubusercontent.com/Bypass-wq/Discord-Server-clone/main/1fe9359f6670cce5864200cab64eb9d7.png')
        $wr.Timeout = 5000
        $resp = $wr.GetResponse()
...
$lblTitle.Text      = [char]0x2601 + ' Santoyo Clicker ' + [char]0x2601
...
$lblCredits.Text      = 'Made By Santoyo'
